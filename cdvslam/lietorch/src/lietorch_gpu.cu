...
__global__ void exp_forward_kernel(NON_WINDOWS_CONST scalar_t* a_ptr, scalar_t* X_ptr, int num_threads) {
...
template <typename Group, typename scalar_t>
__global__ void exp_backward_kernel(NON_WINDOWS_CONST scalar_t* grad, NON_WINDOWS_CONST scalar_t* a_ptr, scalar_t* da, int num_threads) {
...
template <typename Group, typename scalar_t>
__global__ void log_forward_kernel(NON_WINDOWS_CONST scalar_t* X_ptr, scalar_t* a_ptr, int num_threads) {
...
template <typename Group, typename scalar_t>
__global__ void log_backward_kernel(NON_WINDOWS_CONST scalar_t* grad, NON_WINDOWS_CONST scalar_t* X_ptr, scalar_t* dX, int num_threads) {
...
template <typename Group, typename scalar_t>
__global__ void inv_forward_kernel(NON_WINDOWS_CONST scalar_t* X_ptr, scalar_t* Y_ptr, int num_threads) {
...
template <typename Group, typename scalar_t>
__global__ void inv_backward_kernel(NON_WINDOWS_CONST scalar_t* grad, NON_WINDOWS_CONST scalar_t* X_ptr, scalar_t *dX, int num_threads) {
...
template <typename Group, typename scalar_t>
__global__ void mul_forward_kernel(NON_WINDOWS_CONST scalar_t* X_ptr, NON_WINDOWS_CONST scalar_t* Y_ptr, scalar_t* Z_ptr, int num_threads) {
...
__global__ void mul_backward_kernel(NON_WINDOWS_CONST scalar_t* grad, NON_WINDOWS_CONST scalar_t* X_ptr, NON_WINDOWS_CONST scalar_t* Y_ptr, scalar_t* dX, scalar_t* dY, int num_threads) {
...
template <typename Group, typename scalar_t>
__global__ void adj_forward_kernel(NON_WINDOWS_CONST scalar_t* X_ptr, NON_WINDOWS_CONST scalar_t* a_ptr, scalar_t* b_ptr, int num_threads) {
...
template <typename Group, typename scalar_t>
__global__ void adj_backward_kernel(NON_WINDOWS_CONST scalar_t* grad, NON_WINDOWS_CONST scalar_t* X_ptr, NON_WINDOWS_CONST scalar_t* a_ptr, scalar_t* dX, scalar_t* da, int num_threads) {
...
template <typename Group, typename scalar_t>
__global__ void adjT_forward_kernel(NON_WINDOWS_CONST scalar_t* X_ptr, NON_WINDOWS_CONST scalar_t* a_ptr, scalar_t* b_ptr, int num_threads) {
    // adjoint forward kernel
    using Tangent = Eigen::Matrix<scalar_t,Group::K,1>;
    using Data = Eigen::Matrix<scalar_t,Group::N,1>;
...
template <typename Group, typename scalar_t>
__global__ void adjT_backward_kernel(NON_WINDOWS_CONST scalar_t* grad, NON_WINDOWS_CONST scalar_t* X_ptr, NON_WINDOWS_CONST scalar_t* a_ptr, scalar_t* dX, scalar_t* da, int num_threads) {
    // adjoint backward kernel
    using Tangent = Eigen::Matrix<scalar_t,Group::K,1>;
    using Grad = Eigen::Matrix<scalar_t,1,Group::K>;
    using Data = Eigen::Matrix<scalar_t,Group::N,1>;
...
template <typename Group, typename scalar_t>
__global__ void act_forward_kernel(NON_WINDOWS_CONST scalar_t* X_ptr, NON_WINDOWS_CONST scalar_t* p_ptr, scalar_t* q_ptr, int num_threads) {
...
template <typename Group, typename scalar_t>
__global__ void act_backward_kernel(NON_WINDOWS_CONST scalar_t* grad, NON_WINDOWS_CONST scalar_t* X_ptr, NON_WINDOWS_CONST scalar_t* p_ptr, scalar_t* dX, scalar_t* dp, int num_threads) {
    // adjoint backward kernel
    using Tangent = Eigen::Matrix<scalar_t,Group::K,1>;
    using Grad = Eigen::Matrix<scalar_t,1,Group::K>;
    using Point = Eigen::Matrix<scalar_t,3,1>;
...
template <typename Group, typename scalar_t>
__global__ void act4_forward_kernel(NON_WINDOWS_CONST scalar_t* X_ptr, NON_WINDOWS_CONST scalar_t* p_ptr, scalar_t* q_ptr, int num_threads) {
    // action on point forward kernel
    using Tangent = Eigen::Matrix<scalar_t,Group::K,1>;
    using Data = Eigen::Matrix<scalar_t,Group::N,1>;
...
template <typename Group, typename scalar_t>
__global__ void act4_backward_kernel(NON_WINDOWS_CONST scalar_t* grad, NON_WINDOWS_CONST scalar_t* X_ptr, NON_WINDOWS_CONST scalar_t* p_ptr, scalar_t* dX, scalar_t* dp, int num_threads) {
    // adjoint backward kernel
    using Tangent = Eigen::Matrix<scalar_t,Group::K,1>;
    using Grad = Eigen::Matrix<scalar_t,1,Group::K>;
    using Point = Eigen::Matrix<scalar_t,4,1>;
    ...
    GPU_1D_KERNEL_LOOP(i, num_threads) {
        ...
        NON_WINDOWS_CONST Point q = X.act4(p);
        Eigen::Map<Grad>(dX + i*Group::N) = dq * Group::act4_jacobian(q);
    }
}

template <typename Group, typename scalar_t>
__global__ void as_matrix_forward_kernel(NON_WINDOWS_CONST scalar_t* X_ptr, scalar_t* T_ptr, int num_threads) {
...
template <typename Group, typename scalar_t>
__global__ void orthogonal_projector_kernel(NON_WINDOWS_CONST scalar_t* X_ptr, scalar_t* P_ptr, int num_threads) {
...
template <typename Group, typename scalar_t>
__global__ void jleft_forward_kernel(NON_WINDOWS_CONST scalar_t* X_ptr, NON_WINDOWS_CONST scalar_t* a_ptr, scalar_t* b_ptr, int num_threads) {
