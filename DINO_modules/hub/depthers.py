...
from .dpt import DepthEncoderDecoder, DPTDepthHead
from .utils import _DINOV2_BASE_URL, _make_dinov2_model_name, Padding
...
def _make_dinov2_dpt_depther(
    ...
    **kwargs,
    ...
    model.backbone.register_forward_pre_hook(lambda _, x: Padding(backbone.patch_size)(x[0]))
